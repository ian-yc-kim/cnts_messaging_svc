...
class WebSocketConnectionManager:
    ...
    def __init__(self):
        # Mapping client_id -> WebSocket object
    ...
    def get_subscribers(self, topic_type: str, topic_id: str) -> List[WebSocket]:
        ...
        try:
            ...
            subscriber_websockets = []
            client_ids_to_remove = []
            
            for client_id in self.subscriptions[topic_key]:
                if client_id in self.active_connections:
                    subscriber_websockets.append(self.active_connections[client_id])
                else:
