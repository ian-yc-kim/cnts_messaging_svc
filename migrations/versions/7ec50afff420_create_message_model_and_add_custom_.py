...
def upgrade() -> None:
    ...
    op.create_index('ix_messages_topic_composite', 'messages', ['topic_type', 'topic_id', 'message_type'])
...
def downgrade() -> None:
    ...
    # Drop B-tree indexes before dropping the table - use try/catch to handle non-existent indexes
    try:
    ...
    try:
        op.drop_index('ix_messages_topic_composite', 'messages')
    except Exception:
        pass  # Index doesn't exist, ignore
